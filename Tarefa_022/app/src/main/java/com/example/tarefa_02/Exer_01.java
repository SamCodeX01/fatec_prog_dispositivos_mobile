...
public class Exer_01 extends AppCompatActivity {
    ...
    Button btConverter, btLimpar, btVoltar, btAvancar;
...
//            tvMostrarIdade.setText(String.valueOf(resultado));
...
//                tvOpcao.setText("Etanol é a melhor opção!");
        });
        ...
        btVoltar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Exer_01.this, MainActivity.class);
