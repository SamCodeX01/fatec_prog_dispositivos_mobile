...
public class Tela_05 extends AppCompatActivity {

    RadioButton rbQuestaoA, rbQuestaoB, rbQuestaoC, rbQuestaoD;
    Button btValidar, btProximoQ05;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btProximoQ05 = findViewById(R.id.btProximoQ05);
        ...
        btProximoQ05.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if (!rbQuestaoA.isChecked() && !rbQuestaoB.isChecked() && !rbQuestaoC.isChecked() && !rbQuestaoD.isChecked()){
                    //btProximoQ01.setEnabled(false);
                    Toast.makeText(Tela_05.this, "Selecione uma alternativa!",Toast.LENGTH_LONG).show();
                }
                else{
                    //btProximoQ01.setEnabled(true);
                    funcoes_uteis.proximaTela(Tela_06.class);
                }
            }
        });
    }
