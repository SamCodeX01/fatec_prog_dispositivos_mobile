...
public class Tela_09 extends AppCompatActivity {

    RadioButton rbQuestaoA, rbQuestaoB, rbQuestaoC, rbQuestaoD;
    Button btValidar, btProximoQ09;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btProximoQ09 = findViewById(R.id.btProximoQ09);
        ...
        btValidar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rbQuestaoA.isChecked()){
                    ...
                    rbQuestaoA.setTextColor(Color.GREEN);
                    Resultados.acertos++;
                }
        ...
        btProximoQ09.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!rbQuestaoA.isChecked() && !rbQuestaoB.isChecked() && !rbQuestaoC.isChecked() && !rbQuestaoD.isChecked()){
                    //btProximoQ01.setEnabled(false);
                    Toast.makeText(Tela_09.this, "Selecione uma alternativa!",Toast.LENGTH_LONG).show();
                }
                else{
                    //btProximoQ01.setEnabled(true);
                    funcoes_uteis.proximaTela(Tela_10.class);
                }
            }
        });
    }
