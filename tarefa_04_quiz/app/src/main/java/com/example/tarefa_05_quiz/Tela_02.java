...
public class Tela_02 extends AppCompatActivity {

    RadioButton rbQuestaoA, rbQuestaoB, rbQuestaoC, rbQuestaoD;
    Button btValidar, btProximoQ02;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btProximoQ02 = findViewById(R.id.btProximoQ02);
        ...
        btProximoQ02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!rbQuestaoA.isChecked() && !rbQuestaoB.isChecked() && !rbQuestaoC.isChecked() && !rbQuestaoD.isChecked()){
                    //btProximoQ01.setEnabled(false);
                    Toast.makeText(Tela_02.this, "Selecione uma alternativa!",Toast.LENGTH_LONG).show();
                }
                else{
                    //btProximoQ01.setEnabled(true);
                    funcoes_uteis.proximaTela(Tela_03.class);
                }
            }
        });
